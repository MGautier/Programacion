...
int main()
{
    ...
    Tarjeta 
	    ...
	    american_express(Numero("378282246310005"), hanna, "30/11/2012"),
	    dinners_club(Numero("30569309025904"), rosa, "13/7/2013"),
	    mastercard(Numero("555555555555 4444  "), krispin, "1/1/2014"),
	    australian_bank_card(Numero("5610591081018250"), krispin, "2/2/2012"),
	    jcb(Numero("3530111333300000"), rosa, "7/7/2017"),
	    visa2(Numero(" 4222222222222"), lucas, "2/2/2012");
