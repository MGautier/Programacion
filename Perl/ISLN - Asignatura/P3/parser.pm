...
BEGIN
{
    ...
    our @EXPORT = qw( mostrar_mensaje mostrar_mensaje_largo introducir_texto leer_xml sara hash_return prompt ); #Funciones y variables que se exportaran por defecto
